...
and [<AllowNullLiteral>] JQueryStatic =
...
type Globals =
    [<Global>] static member jQuery with get(): JQueryStatic = failwith "JS only" and set(v: JQueryStatic): unit = failwith "JS only"
